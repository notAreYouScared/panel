...
return [
    ...
    'import_export' => [
        ...
        'export_description' => "Export the server's configuration, settings, limits, allocations, and variable values to a YAML file.",
    ...
    'import_errors' => [
        ...
        'egg_not_found' => 'Egg does not exist in the system',
        'egg_not_found_desc' => "Egg with UUID ':uuid' (name: :name) does not exist in the system",
